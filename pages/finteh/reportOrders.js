...
export default function ReportOrders() {
  ...
  return <LayoutFinteh>
    ...
    <div className="text-center m-8">
      ...
      <select className="border-2 border-black mx-4 " onChange={e => setManyDays(e.target.value)}>
    ...
    {(manyDays === "1" && !dateOne) &&
    <div className="text-center m-8">
      <input className="border-2 border-black" type={'date'} onChange={e => foundOne(createDate(e.target.value))}/>
    </div>}
    {(manyDays === "1" && dateOne) &&
